...
class EnhancedRandomForestV2:
    """Enhanced Random Forest V2 with Feature Selection and Hyperparameter Tuning"""
    ...
    def evaluate(self, X_test, y_test):
        ...
        print("Evaluating enhanced model V2 performance...")
...
def main():
    """Main function to run Enhanced Random Forest V2"""
    print("=" * 60)
    print("Enhanced Random Forest V2 - Feature Selection + Hyperparameter Tuning")
    print("=" * 60)
    ...
    try:
        ...
        # 3. Train enhanced model V2
        print("\n3. Training Enhanced Random Forest V2...")
        enhanced_rf_v2 = EnhancedRandomForestV2(
            n_estimators=100,
            max_depth=15,
            random_state=42
        )
        
        enhanced_rf_v2.train(
            X_train, y_train, 
        ...
        print("\n4. Evaluating enhanced model V2 performance...")
        results = enhanced_rf_v2.evaluate(X_test, y_test)
        
        # 5. Show results
        print("\n" + "=" * 40)
        print("Enhanced Model V2 Results:")
        print("=" * 40)
        ...
        print("\n5. Saving enhanced model V2...")
        os.makedirs("Enhancemodle/Enhanced_Random_Forest_2", exist_ok=True)
        model_path = "Enhancemodle/Enhanced_Random_Forest_2/enhanced_random_forest_v2_model.pkl"
        enhanced_rf_v2.save_model(model_path)
        print(f"Enhanced model V2 saved to: {model_path}")
        
        print("\nEnhanced training V2 completed!")
        print("=" * 60)

#!/usr/bin/env python3
"""
Generate evaluation report for Random Forest with Feature Selection and Hyperparameter Tuning
"""
...
def main():
    """Generate evaluation report for Random Forest with Feature Selection and Hyperparameter Tuning model"""
    print("=" * 60)
    print("Generating Random Forest with Feature Selection and Hyperparameter Tuning Evaluation Report")
    print("=" * 60)
    ...
    results_text = f"""Random Forest with Feature Selection and Hyperparameter Tuning Forest Segmentation Model - Comprehensive Evaluation Results
================================================================================
...
"""
    ...
    output_file_path = os.path.join(current_dir, "comprehensive_evaluation_results_Hyperparameter Tuning.txt")

    with open(output_file_path, "w", encoding='utf-8') as f:
        f.write(results_text)

    print("Evaluation report Hyperparameter Tuning generated successfully!")
    print(f"Results saved to: {output_file_path}")
    
    print("Evaluation report VHyperparameter Tuning generated successfully!")
    print(f"Results saved to: comprehensive_evaluation_results_Hyperparameter Tuning.txt")

#!/usr/bin/env python3
"""
Generate evaluation report for Random Forest with Ensemble Sampling Optimization
"""
...
def main():
    """Generate evaluation report for Random Forest with Ensemble Sampling Optimization model"""
    print("=" * 60)
    print("Generating Random Forest with Ensemble Sampling Optimization Evaluation Report")
    print("=" * 60)
    ...
    results_text = f"""Random Forest with Ensemble Sampling Optimization Forest Segmentation Model - Comprehensive Evaluation Results
================================================================================
...
Training Efficiency: {actual_results['training_time']:.2f} seconds 
"""
    
    # Save results
    current_dir = os.path.dirname(os.path.abspath(__file__))

    output_file_path = os.path.join(current_dir, "comprehensive_evaluation_results_sampling_optimization.txt")

    with open(output_file_path, "w", encoding='utf-8') as f:
        f.write(results_text)

    print("Evaluation report sampling_optimization generated successfully!")
    print(f"Results saved to: {output_file_path}")
    
    print("Evaluation report sampling optimization generated successfully!")
    print(f"Results saved to: comprehensive_evaluation_results__sampling_optimization.txt")

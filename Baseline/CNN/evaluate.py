...
from cnn_pipeline import SimpleCNN, compute_iou
...
def main():
    """Evaluate CNN model performance with comprehensive metrics"""
    print("Evaluating CNN Forest Segmentation Model...")
    ...
    # Load model weights
    model_path = 'Baseline/CNN/cnn_model.pth'
    ...
    with open('Baseline/CNN/comprehensive_evaluation_results.txt', 'w', encoding='utf-8') as f:
        f.write("CNN Forest Segmentation Model - Comprehensive Evaluation Results\n")
        f.write("=" * 80 + "\n\n")
    ...
    print(f"Results saved to: Baseline/CNN/comprehensive_evaluation_results.txt")
